...
export default function Register() {
  ...
  const { mutate: handleRegister, isPending: isPendingRegister } = useMutation({
    mutationFn: (formData) => {
      setErrMsg("");
      setSuccMsg("");
      return apiServices.register(formData);
    },
    onSuccess: (res) => {
      console.log(res);
    ...
    <>
      <div className="flex items-center max-w-[600px] w-full shadow-xl p-5 rounded-2xl bg-[#F9FFFB] dark:bg-slate-900">
        <div className="py-10 px-5 w-full border-2 border-black/10 dark:border-white/30 rounded-lg relative">
          ...
          <Form className="w-full mt-7" onSubmit={handleSubmit(handleRegister)}>
            <div className="w-full grid md:grid-cols-2 gap-6">
              ...
              <div className="w-full relative col-span-2 md:col-span-2">
                <Input
                  isRequired={true}
                  classNames={{
                    inputWrapper:
